...
Any additional documents (optional)
    ...
    claim_indian_maternal = models.BooleanField(blank=False, verbose_name="Claim to Indian descent via maternal grandparents")
    claim_indian_paternal = models.BooleanField(blank=False, verbose_name="Claim to Indian descent via paternal grandparents")
    # second page:
